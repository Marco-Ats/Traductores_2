...
linea:    PRINT PARENTESIS_A cadena_io PARENTESIS_C
        ...
        | LIST ID OP_IGUAL CORCHETE_A elementos CORCHETE_C
        | ID PUNTO INSERT CORCHETE_A indice CORCHETE_C OP_IGUAL valor 
        | ID PUNTO POP CORCHETE_A indice CORCHETE_C
        | IF PARENTESIS_A exp_bool PARENTESIS_C LLAVE_A codigo PUNTOYCOMA LLAVE_C
        | WHILE PARENTESIS_A exp_bool PARENTESIS_C LLAVE_A codigo PUNTOYCOMA LLAVE_C
        | op_inc_dec
